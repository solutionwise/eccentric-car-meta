...
const _routes = [
  {
    name: "admin",
    path: "/admin",
    component: () => import('./admin-BSZxpu3K.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-oK5LMZuC.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-DlV2FxXN.mjs')
  },
  {
    name: "tags-demo",
    path: "/tags-demo",
    component: () => import('./tags-demo-yE7YbKib.mjs')
  },
  {
    name: "shadcn-test",
    path: "/shadcn-test",
    component: () => import('./shadcn-test-4qbM_Mt2.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BTIIzWVX.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-fUrAoqLd.mjs'));
...
export { useNuxtApp as a, useRouter as b, nuxtLinkDefaults as c, defineNuxtRouteMiddleware as d, entry$1 as default, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRuntimeConfig as u };
